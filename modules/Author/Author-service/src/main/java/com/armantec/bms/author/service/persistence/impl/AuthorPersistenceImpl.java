...
import com.armantec.bms.author.service.persistence.AuthorUtil;
import com.armantec.bms.author.service.persistence.impl.constants.BmsPersistenceConstants;
 ...
 * @generated
 */
@Component(service = {AuthorPersistence.class, BasePersistence.class})
public class AuthorPersistenceImpl
	...
	public Author[] findByName_PrevAndNext(
		...
		try {
			...
			array[0] = getByName_PrevAndNext(
				session, author, name, orderByComparator, true);

			array[1] = author;

			array[2] = getByName_PrevAndNext(
				session, author, name, orderByComparator, false);
	...
	protected Author getByName_PrevAndNext(
		Session session, Author author, String name,
		OrderByComparator<Author> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_NAME_NAME_3 =
		"(author.name IS NULL OR author.name = '')";
	...
	@Reference
	private AuthorModelArgumentsResolver _authorModelArgumentsResolver;
