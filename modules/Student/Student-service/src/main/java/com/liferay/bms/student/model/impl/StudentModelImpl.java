...
import com.liferay.bms.student.model.StudentModel;
...
/**
 * The base model implementation for the Student service. Represents a row in the &quot;BMS_Student&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class StudentModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "BMS_Student";

	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"rollNo", Types.BIGINT},
		{"groupId", Types.BIGINT}, {"companyId", Types.BIGINT},
		{"userId", Types.BIGINT}, {"userName", Types.VARCHAR},
		{"createDate", Types.TIMESTAMP}, {"modifiedDate", Types.TIMESTAMP},
		{"name", Types.VARCHAR}, {"branch", Types.VARCHAR},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("rollNo", Types.BIGINT);
	...
	public static final String TABLE_SQL_CREATE =
		"create table BMS_Student (uuid_ VARCHAR(75) null,rollNo LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,branch VARCHAR(75) null,email VARCHAR(75) null,mobile VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table BMS_Student";

	public static final String ORDER_BY_JPQL = " ORDER BY student.name ASC";

	public static final String ORDER_BY_SQL = " ORDER BY BMS_Student.name ASC";
	...
	static {
		...
		attributeGetterFunctions.put("rollNo", Student::getRollNo);
		attributeSetterBiConsumers.put(
			"rollNo", (BiConsumer<Student, Long>)Student::setRollNo);
		...
		attributeGetterFunctions.put("mobile", Student::getMobile);
		attributeSetterBiConsumers.put(
			"mobile", (BiConsumer<Student, String>)Student::setMobile);
	...
	public Object clone() {
		...
		studentImpl.setMobile(getMobile());
	...
	public Student cloneWithOriginalValues() {
		...
		studentImpl.setRollNo(this.<Long>getColumnOriginalValue("rollNo"));
		...
		studentImpl.setMobile(this.<String>getColumnOriginalValue("mobile"));
	...
	public CacheModel<Student> toCacheModel() {
		...
		studentCacheModel.mobile = getMobile();

		String mobile = studentCacheModel.mobile;

		if ((mobile != null) && (mobile.length() == 0)) {
			studentCacheModel.mobile = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("rollNo", _rollNo);
