...
package com.liferay.bms.student.service.persistence.impl;

import com.liferay.bms.student.exception.NoSuchStudentException;
import com.liferay.bms.student.model.Student;
import com.liferay.bms.student.model.StudentTable;
import com.liferay.bms.student.model.impl.StudentImpl;
import com.liferay.bms.student.model.impl.StudentModelImpl;
import com.liferay.bms.student.service.persistence.StudentPersistence;
import com.liferay.bms.student.service.persistence.StudentUtil;
import com.liferay.bms.student.service.persistence.impl.constants.BMSPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	public Student[] findByUuid_PrevAndNext(
		...
		Student student = findByPrimaryKey(rollNo);
	...
	public Student[] findByName_PrevAndNext(
		...
		try {
			...
			array[0] = getByName_PrevAndNext(
				session, student, name, orderByComparator, true);

			array[1] = student;

			array[2] = getByName_PrevAndNext(
				session, student, name, orderByComparator, false);
	...
	protected Student getByName_PrevAndNext(
		Session session, Student student, String name,
		OrderByComparator<Student> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_NAME_NAME_3 =
		"(student.name IS NULL OR student.name = '')";
	 ...
	 */
	@Override
	public Student create(long rollNo) {
		Student student = new StudentImpl();

		student.setNew(true);
		student.setPrimaryKey(rollNo);
	 ...
	 */
	@Override
	public Student remove(long rollNo) throws NoSuchStudentException {
		return remove((Serializable)rollNo);
	}
	 ...
	 */
	@Override
	public Student findByPrimaryKey(long rollNo) throws NoSuchStudentException {
		return findByPrimaryKey((Serializable)rollNo);
	}
	 ...
	 */
	@Override
	public Student fetchByPrimaryKey(long rollNo) {
		return fetchByPrimaryKey((Serializable)rollNo);
	}
	...
	@Override
	@Reference(
		target = BMSPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = BMSPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
