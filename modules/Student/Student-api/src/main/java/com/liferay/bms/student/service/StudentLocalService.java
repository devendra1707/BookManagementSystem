...
public interface StudentLocalService
	...
	public Student createStudent(long rollNo);
	...
	public Student deleteStudent(long rollNo) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Student fetchStudent(long rollNo);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Student getStudent(long rollNo) throws PortalException;
