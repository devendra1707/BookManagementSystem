 ...
 * <code>com.liferay.bms.student.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.bms.student.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Student createStudent(long rollNo) {
		return getService().createStudent(rollNo);
	}
	 ...
	 */
	public static Student deleteStudent(long rollNo) throws PortalException {
		return getService().deleteStudent(rollNo);
	}
	...
	public static Student fetchStudent(long rollNo) {
		return getService().fetchStudent(rollNo);
	}
	 ...
	 * @throws PortalException if a student with the primary key could not be found
	 */
	public static Student getStudent(long rollNo) throws PortalException {
		return getService().getStudent(rollNo);
	}
